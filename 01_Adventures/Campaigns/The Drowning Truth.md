...
- 30-foot thick layer of normal water
- Allows minor self-deceptions
- Visitors feel increasingly uncomfortable
- Temperature drops as truth approaches

**The Middle Layer (Uncomfortable Truths)**
- 50-foot thick layer of heavy water
- Partial truths become visible
- Self-deceptions begin failing
- Physical pressure doubles

**The Core (Absolute Truth)**
- 220-foot diameter sphere of liquid crystal
- No deception possible
- All thoughts become visible
- Reality itself cannot lie

### Metaphysical Properties

**Truth Pressure**
The closer one gets to the center, the greater the "truth pressure":
- **Outer Shell**: White lies become difficult
- **Middle Layer**: Cannot speak falsehoods
- **Core**: Cannot even think untruths

**Reality Enforcement**
- Illusions instantly dispel
- Shapeshifters revert to true forms
...
**Saving Throws** Int +8, Wis +10, Cha +3
**Skills** Insight +14, Investigation +8, Perception +10
...
- **Perceive.** The Confessor learns one truth about a creature they can see.
- **Speak Truth.** The Confessor reveals a minor truth, forcing one creature to make a saving throw against Painful Honesty.
...
- **Chamber of Crimes**: All unpunished sins
- **Chamber of Heroes**: Which heroes were actually cowards
...
- Past actions replay as holograms
- Verdict is absolute and binding

**Cost**: 10,000 gp (paid regardless of outcome)
**Risk**: May reveal other crimes
...
- True compatibility shown
- Future possibilities glimpsed
...
- Confesses crimes for closure
- Passes on true wisdom
...
- Single use *zone of truth*
- No save allowed
- Lasts 1 hour

**Major Truth Crystal** (5,000 gp)
- Permanent *true seeing*
- Reveals one absolute truth per day
- Cursed: Cannot tell "white lies"

**Perfect Truth Crystal** (Artifact)
- Shows the complete truth of any situation
- Can rewrite false histories
...
- Wounds inflicted cannot be healed by false means
...
- Love sometimes needs selective blindness
...
**Managing Truth Reveals**:
- Start with minor truths
- Build to significant revelations
- Allow saves for devastating truths
- Give players agency in what's revealed

**Balancing Honesty**:
- Not all truths need speaking
- Context matters for revelations
- Allow "technical truths"
- Respect player boundaries

### Scaling Challenges

**Low Level (1-5)**:
- Visit outer shell only
- Minor truth challenges
...
**High Level (11-15)**:
- Enter the core
- Face absolute honesty
- Reality-altering truths
