...
- Gain `dice: 1d4` Ideological Power
...
- +`dice: 1d8` Ideological Power
- -`dice: 1d6` Political Power (brutality) ### Territory Resources Each territory provides resources based on type: #### Depth Zones (Aquabyssos) **Sunlight Zone Territories**
...
- Pay cost (1000gp × territory value) **Step 2: Opposition**
- Defender commits forces
- Allies may intervene
- Calculate total forces **Step 3: Resolution**

**Attacker Roll**: `dice: 1d20` + Military Power + Tactical Bonuses
**Defender Roll**: `dice: 1d20` + Military Power + Terrain Bonuses + Fortifications **Outcome**:
...
- Loser loses Military Power (`dice: 1d10`)
...
- Roll: `dice: 1d20` + Political Power/10
...
Each side rolls `dice: 1d20` + (Force Strength/100) **Step 4: Determine Outcome** | Difference | Result |
|------------|--------|
