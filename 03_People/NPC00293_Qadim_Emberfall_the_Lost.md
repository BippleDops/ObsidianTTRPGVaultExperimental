...
- **Quirks**: Collects buttons, Always rhymes when speaking, Always barefoot
- **Fear**: Failure
...
- Spellcasting: 2 spell slots, knows Sleep, Invisibility, Fly, Magic Missile
...
- Requires [[ITEM01217_Superior_Oil_of_Swiftness
- Compare with [Symbol Heraldry the Scream Archives V1 the Scream Archives.svg]]
- Compare with [[Faction Name
...
- Affected by [mangonel-xdmg (objects)]]
- Influences [[ENC00207_Combat_Encounter_208
- See also: [protection-from-energy-xphb (spells)]]
- Leads to [[ITEM00678_Warded_Leather_of_Fortitude
- Originates from [step_032 (phase_017)]]
- Leads to [[step_062 (phase_069)
- Related: [SPELL0011_Mystic_Shield]]
- Leads to [[Assets Locations Location City Mad Oracle Thessaly Mad Oracle Thessaly.svg
- Parallels [step_057 (phase_040)]]
- Originates from [[NPC01521_Malakai_Proudmore_the_Bold
- Leads to [ITEM00645_Ethereal_Leather_of_the_Guardian]]
- Connects to [[Location City Doctor Silas Voidtouch Doctor Silas Voidtouch.svg
- Originates from [09 Appendix a the Multiverse]]
- See also: [[layers-of-acheron-xdmg (tables)
...
- Originates from [Tradition Keeper Elder Wisdom (NPCs)]]
- See also: [[portrait-npc-seventh-shard-v1-seventh-shard.svg_1 (Portraits)
