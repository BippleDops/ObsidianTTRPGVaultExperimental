...
## Portrait
![[04_Resources/Assets/Portraits/portrait_lady_jade_clawgrip_dramatic.png]]
...
**Claw Strike.** *Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 12 (`dice: `dice: 2d8`` + 3) slashing damage plus 7 (`dice: `dice: 2d6``) cold damage. If the target is a humanoid, they must succeed on a **DC 19** Constitution saving throw or be marked with Jade's draconic claim, giving her advantage on all social interactions with that creature for 24 hours.

**Frost Breath (Recharge 5-6).** Jade exhales freezing energy in a 30-foot cone. Each creature in that area must make a **DC 19** Constitution saving throw, taking 54 (`dice: `dice: 12d8``) cold damage on a failed save, or half as much on a successful one. Creatures that fail the save are also restrained by ice for 1 minute (can repeat the save at end of each turn).
