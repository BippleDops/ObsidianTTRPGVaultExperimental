...
## Portrait
![[04_Resources/Assets/Portraits/portrait_assassin_standard.png]]
...
**Assassinate.** During the first round of combat, Vespara has advantage on attack rolls against creatures that haven't taken a turn yet. Any hit she scores against a surprised creature is a critical hit.

**Shadow Step.** As a bonus action, Vespara can teleport up to 60 feet to an unoccupied space she can see that is in dim light or darkness.

**Sneak Attack.** Once per turn, Vespara deals an extra 21 (`dice: `dice: 6d6``) damage when she hits a target with a weapon attack and has advantage on the attack roll.

**Crystal Shard Poison.** Vespara's weapons are coated with crystallized shadow essence. Targets hit must make a **DC 16** Constitution saving throw or take 7 (`dice: `dice: 2d6``) necrotic damage and be poisoned for 1 minute.

**Evasion.** When subjected to an effect that allows a Dex saving throw for half damage, Vespara takes no damage on success and half on failure.

## Actions

**Multiattack.** Vespara makes two attacks with her Shadow Blade or throws two Crystal Shards.

**Shadow Blade.** *Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:* 9 (`dice: `dice: 1d8`` + 5) piercing damage plus 7 (`dice: `dice: 2d6``) necrotic damage.

**Crystal Shard.** *Ranged Weapon Attack:* +10 to hit, range 20/60 ft., one target. *Hit:* 8 (`dice: `dice: 1d6`` + 5) piercing damage plus poison effect.

**Infiltrate (3/Day).** Vespara casts *pass without trace* or *invisibility* (self only).
...
**Complicated:**
- **Captain Aldric Shadowmend** - Former lover turned political rival
- **The Shadow Courts** - She owes them a debt that grows heavier each day

## Quest Hooks

1. **The Crystal Heart Contract** - Vespara has been hired to steal the Heart of Aethermoor, but the job feels wrong. She needs the party's help to uncover who's really behind the contract.

2. **Shadow Debt** - The Shadow Courts are calling in Vespara's debt. She must complete three impossible tasks or forfeit her soul. She reluctantly seeks allies.
...
**Ideals**: "Death should have meaning. I am the sword that cuts away corruption, even if I must be corrupted to wield it."

**Bonds**: "My brother's death will be avenged, no matter the cost to my soul."
