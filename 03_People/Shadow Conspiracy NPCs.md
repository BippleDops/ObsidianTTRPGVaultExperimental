...
## Portrait
![[04_Resources/Assets/Portraits/portrait_shadow_conspiracy_npcs_friendly.png
...
## Overview
Shadow Conspiracy NPCs is a notable figure in the realm, known for their unique skills and complex motivations.
...
## Background
Born into modest circumstances, Shadow Conspiracy NPCs rose through dedication and cunning to their current position.
...
**Attack.** *Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 4 (`dice: `dice: 1d6`` + 1) slashing damage.
