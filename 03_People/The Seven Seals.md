...
## Portrait
![[04_Resources/Assets/Portraits/portrait_the_seven_seals_dramatic.png]]
...
**Hit Points** 180 (`dice: `dice: 19d8`` + 95)
...
**Seal Bearer.** Malachus cannot be killed while his Anchor Point remains intact. If reduced to 0 hit points, he reforms at the Anchor Point in `dice: `dice: 1d10`` days.
...
**Tidecaller (Trident).** *Melee or Ranged Weapon Attack:* +11 to hit, reach 10 ft. or range 30/90 ft., one target. *Hit:* 14 (`dice: `dice: 2d8`` + 5) piercing damage plus 9 (`dice: `dice: 2d8``) force damage. If thrown, it returns to his hand immediately.
...
**Traits**: Cautious, disciplined, clever
...
The Seven Seals is currently engaged in:
...
2. **The Opposition**: Someone wants The Seven Seals stopped or removed
3. **The Secret**: Information about The Seven Seals's past surfaces
