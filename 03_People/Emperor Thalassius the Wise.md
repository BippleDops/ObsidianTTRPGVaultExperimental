...
**Memory of Empire.** Thalassius can access the memories of any creature that has ever sworn fealty to the Aquabyssos throne. As an action, he can perfectly recall any event witnessed by a subject, living or dead.

**Pressure Aura.** Creatures within 30 feet must succeed on a **DC 20** Constitution saving throw at the start of their turn or suffer disadvantage on attack rolls and ability checks as crushing pressure bears down upon them. Aquatic creatures have advantage on this save.

**Spellcasting.** Thalassius is a 20th-level spellcaster. His spellcasting ability is Intelligence (spell save **DC 22**, +14 to hit). He has the following wizard spells prepared:
- Cantrips (at will): *chill touch*, *mage hand*, *prestidigitation*, *ray of frost*, *shape water*
- 1st level (4 slots): *detect magic*, *magic missile*, *shield*, *thunderwave*
- 2nd level (3 slots): *detect thoughts*, *mirror image*, *misty step*, *hold person*
- 3rd level (3 slots): *counterspell*, *dispel magic*, *tidal wave*, *water breathing*
- 4th level (3 slots): *control water*, *dimension door*, *greater invisibility*, *phantasmal killer*
- 5th level (3 slots): *dominate person*, *scrying*, *telekinesis*, *wall of force*
- 6th level (2 slots): *chain lightning*, *disintegrate*, *globe of invulnerability*
- 7th level (2 slots): *finger of death*, *plane shift*, *reverse gravity*
- 8th level (1 slot): *dominate monster*, *power word stun*, *tsunami*
- 9th level (1 slot): *power word kill*, *time stop*, *wish*

## Actions

**Multiattack.** Thalassius makes two attacks: one with his Trident of the Depths and one with his Depth Blast.

**Trident of the Depths.** *Melee Weapon Attack:* +14 to hit, reach 10 ft., one target. *Hit:* 14 (`dice: `dice: 2d6`` + 7) piercing damage plus 21 (`dice: `dice: 6d6``) cold damage. The target must succeed on a **DC 20** Constitution saving throw or be paralyzed by crushing pressure for 1 minute. The target can repeat the saving throw at the end of each of its turns.

**Depth Blast.** *Ranged Spell Attack:* +14 to hit, range 120 ft., one target. *Hit:* 28 (`dice: `dice: 8d6``) force damage, and the target must make a **DC 20** Strength saving throw or be pushed 30 feet away and knocked prone.

**Disintegrating Touch (Recharge 5-6).** *Melee Spell Attack:* +14 to hit, reach 5 ft., one creature. *Hit:* The target must make a **DC 20** Dexterity saving throw, taking 75 (`dice: `dice: 10d6`` + 40) force damage on a failed save, or half as much on a successful one. If this damage reduces the target to 0 hit points, it is disintegrated.

## Legendary Actions

Thalassius can take 3 legendary actions, choosing from the options below. Only one legendary action can be used at a time and only at the end of another creature's turn. Thalassius regains spent legendary actions at the start of his turn.

- **Cantrip.** Thalassius casts a cantrip.
- **Depth Shift (Costs 2 Actions).** Thalassius becomes invisible until the start of his next turn and teleports up to 60 feet to an unoccupied space he can see.
- **Imperial Command (Costs 3 Actions).** Thalassius targets one creature he can see within 60 feet. The target must succeed on a **DC 20** Wisdom saving throw or be charmed for 24 hours. While charmed, the creature obeys Thalassius's verbal commands. The creature can repeat the saving throw whenever it takes damage.

## Lair Actions

On initiative count 20 (losing initiative ties), Thalassius takes a lair action to cause one of the following effects:

- The pressure in a 60-foot radius sphere increases dramatically. Each creature in that area must succeed on a **DC 20** Constitution saving throw or take 11 (`dice: `dice: 2d10``) force damage and be restrained until initiative count 20 on the next round.
- Thalassius creates a whirlpool in a 40-foot radius, 40-foot high cylinder. Creatures must succeed on a **DC 20** Strength saving throw or be pulled 20 feet toward the center.
- The emperor calls upon ancient memories, causing ghostly apparitions of past subjects to appear. Each enemy within 60 feet must succeed on a **DC 20** Wisdom saving throw or be frightened for 1 minute.
...
1. **The Emperor's Memory** - Thalassius has begun forgetting events from his early reign, suggesting someone is stealing or corrupting the empire's history. He secretly seeks heroes to investigate without alerting the court.
...
**Personality**: Ancient, patient, and melancholic. Speaks in formal, archaic patterns with the weight of millennia behind every word. Often references events from centuries ago as if they happened yesterday.

**Ideals**: "An empire is not built on strength alone, but on the willingness to sacrifice everything for those who cannot protect themselves."

**Bonds**: "I am Aquabyssos, and Aquabyssos is me. We shall endure together or fall as one."

**Flaws**: "I have seen so many generations pass that individual lives sometimes seem fleeting and insignificant. This detachment grows stronger each century."
...
Emperor Thalassius the Wise presents a distinctive figure. Their bearing suggests both competence and experience. Notable features include:
...
Emperor Thalassius the Wise is currently engaged in:
...
2. **The Opposition**: Someone wants Emperor Thalassius the Wise stopped or removed
3. **The Secret**: Information about Emperor Thalassius the Wise's past surfaces
