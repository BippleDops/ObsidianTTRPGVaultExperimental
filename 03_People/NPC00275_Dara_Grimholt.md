...
- **Quirks**: Always barefoot, Speaks to animals like people
- **Fear**: The undead
...
## Current Situation
- **Occupation**: Military commander
- **Resources**: Political connections, Vast wealth, Private army
...
- Originates from [FAC00094_Cults_95]]
- Leads to [[QUEST00103_Main_Quest_104
- Connects to [step_083 (phase_090)]]
- Originates from [[step_074 (phase_041)
- Affected by [Portrait NPC Blackwater Estate V2 Blackwater Estate.svg_1 (Portraits)]]
- Influences [[EVENT00022_Natural_Event_23
...
- Connects to [Mira Shadowtouched]]
- Originates from [[Maelstrom Xge
- Requires [Map Map Embassy Quarter Court Embassy Quarter Court.svg]]
- Influences [[step_030 (phase_040)
- Influences [Location City Marina Clearwater V1 Marina Clearwater.svg]]
...
- Originates from [[step_013 (phase_090)
...
- Parallels [gust-xge (spells)]]
- Influences [[DUN00001_Dungeon_2
- Originates from [The Cloud Shepherd Guild]]
- See also: [[Assets Locations Location City Official Memory Keepers Official Memory Keepers.svg
- Parallels [Handout Handout Cult Text with Marginalia V2 Cult Text with Marginalia.png]]
- Compare with [[Portrait NPC Captain Truth Ironwill V2 Captain Truth Ironwill.svg
